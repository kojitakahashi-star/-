...
LABELS = {
    ...
    "products": "扱っている商品",
    "processing": "扱っている加工",
    "fireproof_materials": "扱っている不燃",
    "wood_species": "対応樹種",
    "fireproof_paint_combination": "不燃商品と塗料の組み合わせ",
    "certified_substrate_combination": "大臣認定をとっている不燃木材と下地材の組み合わせ",
    "fireproof_product_paint_names": "扱っている不燃商品・不燃塗料の名称",
    "features": "特徴",
    "strengths": "強み",
    "source_urls": "参照元",

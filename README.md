...
| 大手内装(ディスプレイ業) | 企画〜デザイン〜施工〜運営を一貫して担う大手ディスプレイ企業 | 乃村工藝社、丹青社、博展、船場 |
...
- 成富法仁（株式会社船場(SEMBA)／エグゼクティブフェロー・エバンジェリスト 兼 Social Design Port所長）
- 平田晶（株式会社船場(SEMBA)／CREATOR事業本部 デザインディレクター）
